...
{
    if (!_arrowImage) {
        UIImageView *arrowImage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"arrow1.png"]];
...
- (void)layoutSubviews
{
    ...
    // 1.箭头
    CGFloat arrowX = self.mj_width * 0.5 - 30;
    self.arrowImage.center = CGPointMake(arrowX, self.mj_height * 0.5-17);
